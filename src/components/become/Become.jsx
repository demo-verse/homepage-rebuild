              ...
              <div className="become-text-right">
                ...
                <div>
                  <p>
                    ...
                    and lately became part of the umbrella project,{" "}
                    <a
                    ...
                    process.
                    <br></br> <br></br>
                    We have discovered new perspectives and imagined better; as
                    we have been building a proof of concept, a peacemaker App in <a
                  ...
                  <div className="circlesOfPeaceButton">
                    {circlesOfPeaceButton}
                  </div>
                  ...
                  <p>
                    For all that, calling everyone to live and leave a priceless
                    legacy; namingly,{" "}
                    <strong> a World Peace through Equality and Equity</strong>.
                  </p>
                  <p>
